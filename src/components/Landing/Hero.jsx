    ...
    >
      ...
      <div className="container mx-auto px-6 pb-20 flex flex-col-reverse lg:flex-row items-center justify-center gap-10 lg:gap-20 z-10">
        <div className="flex flex-col gap-4 flex-1 text-center lg:text-left items-center lg:items-start max-w-2xl">
          ...
          <p className="text-slate-300 text-base lg:text-lg leading-relaxed max-w-lg mt-2 font-light">
        ...
        <div className="flex justify-center lg:justify-end w-full lg:w-auto relative">
          ...
          <img
            ...
            className="relative w-72 lg:w-full lg:max-w-md h-auto drop-shadow-2xl transform hover:scale-105 transition-transform duration-500"
          />
        </div>
      </div>
    </section>
